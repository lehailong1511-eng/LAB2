...
//Date        : Wed May 20 13:27:37 2026
//Host        : LAPTOP-EQCLE5J0 running 64-bit major release  (build 9200)
//Command     : generate_target LAB2D_Timer.bd
//Design      : LAB2D_Timer
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "LAB2D_Timer,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=LAB2D_Timer,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_board_cnt=2,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "LAB2D_Timer.hwdef" *) 
module LAB2D_Timer
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  LAB2D_Timer_axi_gpio_0_0 axi_gpio_0
  ...
  LAB2D_Timer_axi_gpio_1_0 axi_gpio_1
  ...
  LAB2D_Timer_axi_timer_0_0 axi_timer_0
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
  ...
  LAB2D_Timer_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  LAB2D_Timer_rst_ps7_0_50M_0 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  LAB2D_Timer_xlconcat_0_0 xlconcat_0
